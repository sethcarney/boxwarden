...
import { readBranches, switchBranch } from './git/branches.js';
import { fakeBranches, fakeGitStatus, fakeSwitchBranch } from './git/fake.js';
  ...
  registerIpcHandlers({
    ...
    git: {
      ...
      ...(process.env['BOXWARDEN_FAKE_DOCKER'] === '1'
        ? { status: fakeGitStatus, branches: fakeBranches, switchBranch: fakeSwitchBranch }
        : { status: readGitStatus, branches: readBranches, switchBranch }),
    },
    projects: {
      platform: process.platform,
